...
namespace Moral.UI
{
    public static class GlowBorderWindowExtention
    {
        ...
        public static void SetupGlowBorderWindow(this Window window)
        {
            if (!window.GlowBorderWindow())
            {
        ...
        private static bool GlowBorderWindow(this Window window)
        {
            try
            {
