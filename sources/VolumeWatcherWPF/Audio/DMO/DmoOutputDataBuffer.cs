...
namespace Audio.DMO
{
    ...
    public struct DmoOutputDataBuffer : IDisposable
    {
        ...
        EDmoOutputDataBufferFlags dwStatus;
        long rtTimestamp;
        ...
        public DmoOutputDataBuffer(int maxBufferSize)
        {
            ...
            dwStatus = EDmoOutputDataBufferFlags.None;
            rtTimestamp = 0;
        ...
        /// Status Flags
        /// </summary>
        public EDmoOutputDataBufferFlags StatusFlags
        {
            get { return dwStatus; }
        ...
        public bool MoreDataAvailable
        {
            get
            {
                return (StatusFlags & EDmoOutputDataBufferFlags.Incomplete) == EDmoOutputDataBufferFlags.Incomplete;
            }
        }
    }
}
